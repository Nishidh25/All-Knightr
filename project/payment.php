...
echo "Total Cost: ".$_SESSION["total_price"]."<br> <br>";
...
if($conn->query($sql) === TRUE) {echo "Payment sucessfull!";?><br><br><button class="" onclick="loggedin()">Home</button><?php }
}
}else {echo "Insufficient Balance"."<br><br><button onclick='loggedin()'>Home</button>";}
echo "</div>";
?>
...
<script>
function Alert() {
  alert("Payment Complete! \nItems will be delivered to you via email");
